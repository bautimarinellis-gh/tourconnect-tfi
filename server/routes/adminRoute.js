...
const {
  ...
  deleteMayorista,
  reactivarMayorista,
  verificarDesactivacionMayorista,
  getHistorialMayorista,
...
router.get('/mayoristas/:id/verificar-desactivacion', verificarDesactivacionMayorista);
router.get('/mayoristas/:id/historial', getHistorialMayorista);
