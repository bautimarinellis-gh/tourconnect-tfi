...
const CATEGORIA_POR_ACCION = {
  ...
  AGENCIA_ACTUALIZADA: 'negocio',
  USUARIO_REACTIVADO: 'seguridad',
  ACTIVACION_MANUAL_USUARIO: 'seguridad',
  MAYORISTA_REACTIVADO: 'seguridad',
  CAMBIO_PASSWORD: 'seguridad',
  ROL_CREADO: 'seguridad',
  ROL_ACTUALIZADO: 'seguridad',
  ROL_ELIMINADO: 'seguridad',
  ROL_ASIGNADO: 'seguridad',
  ROL_DESASIGNADO: 'seguridad',
  PERMISO_INDIVIDUAL_ASIGNADO: 'seguridad',
  PERMISO_INDIVIDUAL_REVOCADO: 'seguridad',
